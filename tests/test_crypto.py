...
class TestPasswordGeneration:
    ...
    def test_generate_password_with_limited_charsets(self):
        ...
        pw = generate_password(
            length=10, upper=False, lower=False, digits=True, symbols=False
        )
    ...
    def test_generate_password_requires_at_least_one_charset(self):
        ...
        with pytest.raises(ValueError):
            generate_password(upper=False, lower=False, digits=False, symbols=False)
